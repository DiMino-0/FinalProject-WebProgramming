...
(1, 'john_doe', 'john.doe@example.com', 'user', '1990-01-01', 'male', 'https://example.com/john_doe.jpg'),
(2, 'jane_smith', 'jane.smith@example.com', 'user', '1992-02-02', 'female', 'https://example.com/jane_smith.jpg'),
(3, 'alice_jones', 'alice.jones@example.com', 'admin', '1988-03-03', 'female', 'https://example.com/alice_jones.jpg');
...
(3, 3, NULL, 'Yoga', '1 hour', 'Home', 'Feeling relaxed after yoga.', 'Yoga Session', '2023-10-03');
